...
namespace ITCompany_v1._0.Model
{
    class UserCreateModel
    {
        ...
        private UserCreateModel()
        {
            ...
            {
                new UserModel("admin","admin",true,false,false,false),
                new UserModel("user","user",false,false,false,true),
                new UserModel("hr","hr",false,true,false,false),
                new UserModel("pm","pm",false,false,true,false)
            };
        }
